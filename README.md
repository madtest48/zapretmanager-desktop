...
В типичном сценарии она помогает сделать всё за тебя:

- запускает автоматический подбор рабочего конфига
- проверяет доступные конфиги по целям из списка
- сравнивает результаты HTTP, TLS 1.2, TLS 1.3 и ping
- определяет наиболее удачные варианты
- рекомендует лучший конфиг и позволяет сразу перейти к его запуску

То есть для первого старта во многих случаях достаточно просто найти или скачать сборку, а затем нажать `Автоматический режим`.
